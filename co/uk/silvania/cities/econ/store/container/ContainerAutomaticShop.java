...
public class ContainerAutomaticShop extends Container {
	
	private TileEntityAutomaticShop te;
	private IInventory automaticShopInventory;
	
	public ContainerAutomaticShop(InventoryPlayer invPlayer, TileEntityAutomaticShop te) {
		this.te = te;
	...
	public IInventory getFloatingShelvesInveotry() {
		return this.automaticShopInventory;
	}
