...
public class BlockOil extends BlockFluidClassic {
	...
	public BlockOil(int id, Fluid fluid) {
	...
	public void registerIcons(IconRegister icon) {
		stillIcon = icon.registerIcon(FlenixCities_Core.modid + ":OilStill");
		flowingIcon = icon.registerIcon(FlenixCities_Core.modid + ":OilFlowing");
	}
