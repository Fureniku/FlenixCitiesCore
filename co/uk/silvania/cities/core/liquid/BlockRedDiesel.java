...
public class BlockRedDiesel extends BlockFluidClassic {

	public BlockRedDiesel(int id, Fluid fluid) {
	...
	public void registerIcons(IconRegister icon) {
		stillIcon = icon.registerIcon(FlenixCities_Core.modid + ":RedDieselStill");
		flowingIcon = icon.registerIcon(FlenixCities_Core.modid + ":RedDieselFlowing");
	}
