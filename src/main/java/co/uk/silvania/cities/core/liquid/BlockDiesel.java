...
public class BlockDiesel extends BlockFluidClassic {

	public BlockDiesel(int id, Fluid fluid) {
	...
	public void registerIcons(IconRegister icon) {
		stillIcon = icon.registerIcon(FlenixCities_Core.modid + ":DieselStill");
		flowingIcon = icon.registerIcon(FlenixCities_Core.modid + ":DieselFlowing");
	}
