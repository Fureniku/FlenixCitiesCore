...
public class GreenButton extends GuiButton {
    ...
    protected static final ResourceLocation field_110332_a = new ResourceLocation("flenixcities", "textures/gui/greenbutton.png");

    public GreenButton(int par1, int par2, int par3, int par4, int par5, String par6Str) {
