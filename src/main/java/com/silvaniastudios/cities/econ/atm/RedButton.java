...
public class RedButton extends GuiButton {
    ...
    protected static final ResourceLocation textureRed = new ResourceLocation("flenixcities", "textures/gui/redbutton.png");

    public RedButton(int par1, int par2, int par3, int par4, int par5, String par6Str) {
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
        if (this.drawButton) {
            ...
            mc.getTextureManager().bindTexture(textureRed);
