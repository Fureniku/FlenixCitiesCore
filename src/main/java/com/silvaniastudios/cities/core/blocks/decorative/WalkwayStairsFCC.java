...
public class WalkwayStairsFCC extends DecorativeBlockFCC {

	public WalkwayStairsFCC(String textureName, String blockType) {
	...
	public boolean checkConnections(World world, int x, int y, int z, int targetMeta) {
		...
		if (world.getBlock(x, y, z) instanceof WalkwayStairsFCC) {
			return true;
		}
