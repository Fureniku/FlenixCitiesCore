...
public class GenericDecorativeBlock extends CitiesBlockBase implements IMetaBlockName {
	
	public static final PropertyEnum<EnumMeta> META_ID = PropertyEnum.create("block", EnumMeta.class);

	//Just a generic block with no functionality, with 16 variants.
	public GenericDecorativeBlock(String name, CreativeTabs tab) {
