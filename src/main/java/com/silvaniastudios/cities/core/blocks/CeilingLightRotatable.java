...
public class CeilingLightRotatable extends CitiesBlockBase implements IMetaBlockName {
	
	public static final PropertyEnum<EnumMeta> META_ID = PropertyEnum.create("light", EnumMeta.class);

	public CeilingLightRotatable(String name) {
    ...
    public IBlockState getStateForPlacement(World world, BlockPos pos, EnumFacing facing, float hitX, float hitY, float hitZ, int meta, EntityLivingBase placer, EnumHand hand) {
    	int rot = 0;
    	if (placer.getHorizontalFacing().equals(EnumFacing.EAST) || placer.getHorizontalFacing().equals(EnumFacing.WEST))  { rot = 1; }
	...
	public void getSubBlocks(CreativeTabs creativeTabs, NonNullList<ItemStack> list) {
		for (int meta = 0; meta < 8; meta++) {
			list.add(new ItemStack(this, 1, meta*2));
		}
	}
	...
	public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
		...
		return new ItemStack(state.getBlock(), 1, meta-1);
    }
